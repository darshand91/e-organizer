  ...
  function addPage(page, book) {
    ...
    if (!book.turn('hasPage', page)) {
      ...
      setTimeout(function () {
        ...
        //code for notes
        element.html('<h1>NOTES</h1><section contenteditable="true" id="content"><h2 style="font-family: "Sacramento", cursive;"> Go ahead, edit away! </h2></section> <ul id="docList"></ul><input type="text" id="docName" placeholder="Please Enter File Name" style="width: 200px;" /><input type="submit" value="Save" onclick="saveDoc(); return false;"/>');
        }
